            ...
            {showCart && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-900 rounded-t-3xl z-50 max-h-[90vh] overflow-y-auto shadow-2xl"
                    >
                        {/* Header */}
                        <div className="sticky top-0 bg-white dark:bg-gray-900 z-10 p-4 sm:p-6 border-b border-gray-200 dark:border-gray-700 rounded-t-3xl">
                            <div className="flex items-center justify-between mb-2">
                                ...
                                <button
                                    onClick={onClose}
                                    className="w-10 h-10 rounded-full bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 active:scale-90 flex items-center justify-center transition-all"
                                >
                                    <X className="w-6 h-6" />
                                </button>
                            </div>
                        ...
                        <div className="p-4 sm:p-6">
                            {cart.length === 0 ? (
                                <div className="text-center py-12">
                                    ...
                                    <p className="text-gray-500 dark:text-gray-400 text-lg font-medium mb-6">Votre panier est vide</p>
                                    <button
                                        onClick={onClose}
                                        className="px-6 py-3 bg-black dark:bg-white text-white dark:text-black rounded-xl font-bold hover:bg-gray-800 dark:hover:bg-gray-200 active:scale-95 transition-all"
                                    >
