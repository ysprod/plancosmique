...
import { User, LogOut, Menu, X, Home, FileText, Settings, Sparkles, ChevronDown } from "lucide-react";
            ...
            <div className="hidden lg:flex items-center gap-2">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <ChevronDown className={`w-4 h-4 text-violet-600 transition-transform ${showUserMenu ? 'rotate-180' : ''
                    }`} />
                </motion.button>
