...
// Memoized Sidebar Navigation List
const SidebarNav = React.memo(function SidebarNav({ pathname, onNav, isMobile }: { pathname: string, onNav?: () => void, isMobile?: boolean }) {
  return (
...
const SidebarHeader = React.memo(function SidebarHeader({ user }: { user: any }) {
  return (
...
const LogoutButton = React.memo(function LogoutButton({ onLogout, isLoggingOut }: { onLogout: () => void, isLoggingOut: boolean }) {
  return (
    <motion.button
      onClick={onLogout}
              ...
              <>
                ...
                >
                  ...
                  <div className="flex-1 p-3 overflow-y-auto">
                    <SidebarNav pathname={pathname} onNav={() => setShowMobileSidebar(false)} isMobile />
                  </div>
