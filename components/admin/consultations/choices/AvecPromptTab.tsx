...
export function AvecPromptTab({ choicesWithPrompt, onEditPrompt }: AvecPromptTabProps) {
    const withPromptCards = useConsultationChoicesSection(choicesWithPrompt, onEditPrompt);
    return (
