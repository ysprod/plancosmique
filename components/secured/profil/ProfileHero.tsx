...
import { ProfilWelcomeMessage, ProfilGradeCongrats, ProfilUserTypeBanner, ProfilProgressTable } from "@/components/profil/ProfilAutomatedSections";
      ...
      >
        ...
        <div className="p-2 sm:p-4">
          <div className="mx-auto flex flex-col items-center justify-center text-center gap-2">
            ...
            {user?.grade && <GradeMessageDisplay grade={user.grade} />}
