...
import { Calendar, Clock, Eye, Heart, Flame, ArrowRight, MessageCircle, Star, TrendingUp, AlertCircle, User } from 'lucide-react';
...
export default function SpiritualiteArticlesGrid({ featuredArticle, regularArticles, formatDate, setSearchQuery, setSelectedCategory }: Props) {
  return (
    <>
      {featuredArticle && (
        <motion.div
