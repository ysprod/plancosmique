...
export default function AstrologieAfricainePage() {
  const title = "ASTROLOGIE AFRICAINE";
  const description = "Découvrez la sagesse ancestrale et les traditions astrologiques africaines millénaires";
  const icon = Palmtree;
  const color = "from-orange-600 via-red-600 to-amber-700";
  const lightColor = "from-orange-400 to-amber-400";
            ...
            >
              <Link href={service.href}>
                <div className="group relative h-full">
                  ...
                  <div className="relative bg-gradient-to-br from-slate-900/95 via-slate-800/95 to-slate-900/95 backdrop-blur-xl rounded-3xl p-7 border-2 border-slate-700/50 group-hover:border-slate-600 transition-all duration-300 h-full shadow-2xl hover:shadow-[0_0_50px_rgba(168,85,247,0.5)]">
                    <motion.div
