...
export default function SpiritualitePage() {
  const title = "SPIRITUALITÉ AFRICAINE";
  const description = "Reconnectez-vous aux pratiques spirituelles ancestrales et rituels sacrés africains";
  const icon = Flame;
  const color = "from-amber-700 via-orange-700 to-red-700";
  const lightColor = "from-amber-400 to-red-400";
        ...
        {[...Array(100)].map((_, i) => (
          <motion.div
            ...
            style={{
              ...
              background: i % 3 === 0 ? '#f59e42' : i % 3 === 1 ? '#fb923c' : '#ef4444',
            }}
            animate={{
              opacity: [0, 1, 0],
              scale: [0, 1.5, 0]
        ...
        >
          <Link href="/">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="flex items-center gap-2 text-amber-300 hover:text-red-200 transition-colors"
            >
            ...
            >
              <Link href={service.href}>
                <div className="group relative h-full">
                  ...
                  <div className="relative bg-gradient-to-br from-slate-900/95 via-slate-800/95 to-slate-900/95 backdrop-blur-xl rounded-3xl p-7 border-2 border-slate-700/50 group-hover:border-slate-600 transition-all duration-300 h-full shadow-2xl hover:shadow-[0_0_50px_rgba(239,68,68,0.5)]">
                    <motion.div
