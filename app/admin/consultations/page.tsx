      ...
      >
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="w-full bg-slate-800 border border-slate-700 text-white px-10 py-2 rounded-lg focus:outline-none focus:border-purple-500"
          />
        </div>
      ...
      >
        <div className="p-6">
          <p className="text-slate-400 text-center py-8">
            Tableau des consultations à implémenter
          </p>
        </div>
      </motion.div>
    </motion.div>
